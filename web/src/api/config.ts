 ...
 *   检查更新、查询权限状态。本模块封装这些 API 调用。
 *
 * Code Logic:
 *   基于 api client 封装 6 个 API 方法，返回类型化的 Promise。
 */

import { api } from './client';
import type { AppConfig, VersionInfo, UpdateCheckResult, PermissionsStatus } from '@/lib/types';
